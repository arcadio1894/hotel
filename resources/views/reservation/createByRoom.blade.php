        ...
        <div class="" id="rooms">
            <div class="row" id="body-card">
                <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch pb-4">
                    <div class="card d-flex flex-row col-md-12" >
                        <!-- Imagen en la izquierda -->
                        <div class="card-img-left">
                            <img data-image src="{{ asset('/images/rooms/'.$arrayRoom[0]["image"]) }}" alt="" class="img-circle img-fluidcpt-3">
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <div style="display: none;" data-id id="room_id">{{ $arrayRoom[0]["id"] }}</div>
                                    <h2 class="lead text-center"><b data-type_room>{{ $arrayRoom[0]["type_room"] }}</b> <b data-level>{{ $arrayRoom[0]["level"] }}</b><b data-number>{{ $arrayRoom[0]["number"] }}</b></h2>
                                    <ul class="ml-4 mb-0 fa-ul text-muted">
                                        <li class="small"><span class="fa-li"><i class="fas fa-book"></i></span>Descripción: <span data-description>{{ $arrayRoom[0]["description_short"] }}</span></li>
                                        <li class="small"><span class="fa-li"><i class="fas fa-layer-group"></i></span>Piso: <span data-nivel>{{ $arrayRoom[0]["level"] }}</span></li>
                                        <li class="small"><span class="fa-li"><i class="fas fa-check"></i></span>Capacidad: <span data-capacity>{{ $arrayRoom[0]["capacity"] }}</span></li>
                                        <li class="small"><span class="fa-li"><i class="fas fa-dollar-sign"></i></span>Precio: <span data-price>{{ $arrayRoom[0]["level"] }}</span></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="row">
...
@section('scripts')
<script src="{{ asset('js/reservation/allReservations2.js') }}"></script>
<script src="{{ asset('js/reservation/searchRooms2.js') }}"></script>
<script src="{{ asset('js/reservation/generateCost2.js') }}"></script>
