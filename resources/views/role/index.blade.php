...
@section('page-title')
    <div class="row">
        <div class="col-10">
            <h5 class="card-title col-7">Administrar Listado de Roles</h5>
        </div>
        <div class="d-flex justify-content-end col-2">
            @if($tipo == 'lista')
            <button type="button" class="btn btn-outline-success" onclick="addRol()">
...
@section('content')
    ...
    <div class="d-flex flex-wrap flex-stack pb-3">
        <div class="d-flex flex-wrap align-items-center my-1">
            <h5 class=" me-5 my-1"><span id="numberItems"></span> Roles encontrados
