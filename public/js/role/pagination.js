...
function getDataOperations($numberPage) {
    ...
    $.get('/home/roles/get/data/'+$numberPage, {
        description: name,
        tipo: tipo
    }, function(data) {
...
function renderDataOperations(data) {
    ...
    $("#pagination").html('');
    $("#textPagination").html('');
    $("#textPagination").html('Mostrando '+pagination.startRecord+' a '+pagination.endRecord+' de '+pagination.totalFilteredRecords+' roles');
    $('#numberItems').html('');
...
function renderDataTableCard(data) {
    ...
    updateButton.setAttribute('onclick', 'updateRol(this)');
    ...
    deleteButton.setAttribute('onclick', 'deleteRol(this)');
