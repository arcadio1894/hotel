...
function getDataOperations($numberPage) {
    ...
    $.get('/home/permissions/get/data/'+$numberPage, {
        description: name,
        tipo: tipo
    }, function(data) {
...
function renderDataOperations(data) {
    ...
    $("#pagination").html('');
    $("#textPagination").html('');
    $("#textPagination").html('Mostrando '+pagination.startRecord+' a '+pagination.endRecord+' de '+pagination.totalFilteredRecords+' permisos');
    $('#numberItems').html('');
...
function renderDataTableCard(data) {
    ...
    updateButton.setAttribute('onclick', 'updatePermission(this)');
    ...
    deleteButton.setAttribute('onclick', 'deletePermission(this)');
